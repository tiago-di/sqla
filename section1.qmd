...
::: incremental
1. Propor a adoção de uma <u> cultura de segurança</u> baseada no **conhecimento** de **perigos** e **riscos**, em vez de **regras**
2. Conhecer os **perigos dos agentes químicos** e os principais meios de **minimizar os riscos** .
3. Apresentar formas padronizadas de **comunicação de riscos**
...
## Riscos em Laboratórios Acadêmicos {background="#43464B"}
